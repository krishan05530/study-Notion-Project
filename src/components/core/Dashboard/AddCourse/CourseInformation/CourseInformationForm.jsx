...
//         if (editCourse) {
//             // mapping these value woth this string
...
//     }
//     // handle nextbutton on click
//     const onSubmit = async (data) => {
//         // if editing form , create all data 
//         if (editCourse) {
...
//             }
//             else {
//                 toast.error("No chnage made to the form");
//             }
...
//                 <div>
//                     <label className=''>Course Category<sup>*</sup></label>
//                     <select
//                         id='courseCategory'
//                         defaultValue=""
...
//                 {/* for tags need to create custome component */}
//                 {/* <ChipInput
//                     label="Tags"
//                     name="courseTags"
...
//                     }
//                     <IconBtn
//                         text={!editCourse ? "Next" : "Save & Continue"}
//                     />
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <textarea
          ...
          placeholder="Enter Description"
          {...register("courseShortDesc", { required: true })}
          className="form-style resize-x-none min-h-[130px] w-full  text-richblack-800"
        />
        {errors.courseShortDesc && (
          <span className="ml-2 text-xs tracking-wide text-pink-200">
            Course Description is required
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="relative">
          <input
            ...
            className="form-style w-full !pl-12  text-richblack-800"
          />
          <HiOutlineCurrencyRupee className="absolute left-3 top-1/2 inline-block -translate-y-1/2 text-2xl text-richblack-400" />
        </div>
        {errors.coursePrice && (
