...
exports.sendotp = async (req, res) => {
    try {
        ...
        // check if email , user alrdy exist
        const checkUserPresent = await User.findOne({ email });
        // if user exist then return the response
        if (checkUserPresent) {
            return res.status(401).json({
                success: false,
                message: "usr already  registered"
            })
        } 
        ...
        console.log("opt geenrated", otp);

        // otp should be unique , chekc uniqe otp ot noy
        ...
        // xraete an entry  for otp
        const otpBody = await OTP.create(otpPayload);
        console.log(otpBody);

        // return res ponse sucesfull
...
exports.signup = async (req, res) => {
 ...
 // login
  // get dat from req, bady
        // validate 
        // if user not exits (not rgistered)
         // password match
        // token genrate 
...
// // ge oldpass , new pass , confirmpass
// // vlidation
// // updtae the pas in dB
// // send mail - password chnage
// // return res
//     const {oldPassword, newPassword, confirmPassword, password} =req.body;
...
//         return res.status(400).json({
//             success:false,
//             message:"pls enter the newPassword and confirmPassword same",
//         })
//     }
